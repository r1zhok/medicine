<?php 
add_action( 'wp_enqueue_scripts', 'zen_magazine_enqueue_styles' );
function zen_magazine_enqueue_styles() {
	wp_enqueue_style( 'zen-magazine-style', get_template_directory_uri() . '/style.css' ); 
} 

function zen_magazine_enqueue_assets() {
	// Include the file.
	...
	wp_enqueue_style(
		'open sans',
		wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,500;0,600;0,800;1,700&display=swap' ),
		array(),
		'1.0'
	);
}
add_action( 'wp_enqueue_scripts', 'zen_magazine_enqueue_assets' );


function zen_magazine_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_border_color', array(
		'label'       => __( 'Border Color', 'zen-magazine' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_text_color', array(
		'label'       => __( 'Link Color', 'zen-magazine' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
		'settings'    => 'navigation_text_color',
	) ) );
}
add_action( 'customize_register', 'zen_magazine_customize_register', 999 );
if(! function_exists('zen_magazine_customizer_css_final_output' ) ):
	function zen_magazine_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'zen_magazine_customizer_css_final_output' );
endif;
